...
class DebtFormState extends Equatable {
  ...
  bool get showOriginalPrincipalByDefault => mode != DebtFormMode.onboarding;
  bool get showDueDayByDefault => mode != DebtFormMode.onboarding;
  ...
  DebtFormState copyWith({
    ...
    return DebtFormState(
      ...
      pausedUntil:
          clearPausedUntil ? null : (pausedUntil ?? this.pausedUntil),
      ...
      originalPrincipalError:
          clearErrors ? null : (originalPrincipalError ?? this.originalPrincipalError),
      currentBalanceError:
          clearErrors ? null : (currentBalanceError ?? this.currentBalanceError),
      aprError: clearErrors ? null : (aprError ?? this.aprError),
      minimumPaymentError:
          clearErrors ? null : (minimumPaymentError ?? this.minimumPaymentError),
      dueDayError: clearErrors ? null : (dueDayError ?? this.dueDayError),
      ...
      pausedUntilError:
          clearErrors ? null : (pausedUntilError ?? this.pausedUntilError),
      inlineError:
          clearInlineError ? null : (inlineError ?? this.inlineError),
...
class DebtFormCubit extends Cubit<DebtFormState> {
    ...
    if (validation.errors != null) {
      emit(
        state.copyWith(
          ...
          minimumPaymentFloorError:
              validation.errors!.minimumPaymentFloorError,
  ...
  _ValidationResult _validateAndBuildDebt({
    ...
    final minimumPaymentPercent = _parseOptionalPercent(minimumPaymentPercentInput);
    final minimumPaymentFloor = _parseOptionalCurrency(minimumPaymentFloorInput);
    ...
    final errors = _ValidationErrors(
      ...
      dueDayError: dueDay == null
          ...
          : dueDay < 1 || dueDay > 31
              ...
              : null,
      minimumPaymentPercentError: state.requiresMinimumPaymentPercent &&
    ...
    if (state.status == DebtStatus.active && currentBalance == 0) {
      return _ValidationResult(
        errors: errors.copyWith(
          currentBalanceError:
              'Khoản nợ đang hoạt động phải có số dư lớn hơn 0.',
        ),
      );
    }
    ...
    if (state.status == DebtStatus.paidOff && currentBalance != 0) {
      return _ValidationResult(
        errors: errors.copyWith(
          currentBalanceError:
              'Khoản nợ đã trả xong phải có số dư bằng 0.',
        ),
      );
    }
